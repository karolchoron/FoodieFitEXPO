...
export const isWithinCalorieRange = (mealCalories: number, targetCalories: number) =>
    mealCalories >= targetCalories * lowerLimit && mealCalories <= targetCalories * upperLimit;

// wybiera losowy posilek
export const pickRandomMeal7Days = (mealOptions: Dish[], mealType: string): Dish | null => {
...
export const pickMealsFor7Days = async () => {
